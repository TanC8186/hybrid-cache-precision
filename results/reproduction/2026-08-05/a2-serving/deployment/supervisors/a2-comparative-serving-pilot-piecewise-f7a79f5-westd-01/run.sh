...
ATTEMPT=a2-comparative-serving-pilot-piecewise-f7a79f5-westd-01
CONFIG="$ROOT/experiments/configs/a2_comparative_piecewise_serving_f7a79f5.yaml"
...
timeout --signal=TERM --kill-after=30s 7200s bash -lc \
  "PYTHONPATH=. /root/autodl-tmp/MLSys_Research/.venv/bin/python scripts/bench/run_steady_state.py \
    --config '$CONFIG' \
    --phase comparative_pilot \
    --attempt-id '$ATTEMPT' \
    --parent-attempt a2-comparative-serving-mvex-piecewise-f7a79f5-westd-01 \
