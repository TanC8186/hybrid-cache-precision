...
ATTEMPT=a2-packed-serving-debug-piecewise-f7a79f5-westd-01
CONFIG="$ROOT/experiments/configs/a2_packed_piecewise_f7a79f5.yaml"
...
timeout --signal=TERM --kill-after=30s 1800s bash -lc \
  "PYTHONPATH=. /root/autodl-tmp/MLSys_Research/.venv/bin/python scripts/bench/run_steady_state.py \
    ...
    --phase packed_debug \
    --attempt-id '$ATTEMPT' \
    --parent-attempt a2-packed-serving-pilot-d1d52c4-westd-01 \
