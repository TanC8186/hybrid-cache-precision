...
ATTEMPT=a2-comparative-serving-sharegpt300-upper50-piecewise-b3bd79a-westd-01
CONFIG="$ROOT/experiments/configs/a2_comparative_piecewise_sharegpt300_upper50.yaml"
...
timeout --signal=TERM --kill-after=30s 5400s bash -lc \
  "ulimit -n 65535; PYTHONPATH=. /root/autodl-tmp/MLSys_Research/.venv/bin/python scripts/bench/run_steady_state.py \
    --config '$CONFIG' \
    --phase sharegpt_upper_neighbor_r50_mvex \
    --attempt-id '$ATTEMPT' \
    --parent-attempt a2-comparative-serving-sharegpt300-upper-piecewise-934d7de-westd-01 \
