...
ATTEMPT=a2-comparative-serving-random60-pilot-v3-piecewise-fc07868-westd-01
CONFIG="$ROOT/experiments/configs/a2_comparative_piecewise_protocol_v3_random60_pilot.yaml"
...
timeout --signal=TERM --kill-after=30s 3600s bash -lc \
  "ulimit -n 65535; PYTHONPATH=. /root/autodl-tmp/MLSys_Research/.venv/bin/python scripts/bench/run_steady_state.py \
    ...
    --attempt-id '$ATTEMPT' \
    --parent-attempt a2-comparative-serving-sharegpt300-upper50-piecewise-b3bd79a-westd-01 \
