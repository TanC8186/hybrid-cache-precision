...
| 2 | RULER 子集（官方生成器/评分，noise haystack） | `ruler-subset-20260807` | 7 tasks × 2 lengths × 5 alloc × 3 seeds = 210 cells | 数据已生成（14/14 校验通过），等 NIAH 完成自动启动 |
...
| 5 | 推理基准（2B） | `reasoning-20260807` | gsm8k 200 + mmlu 500 + aime25 30，× 5 alloc × 3 seeds | 数据已下载，等 9B 完成 |
